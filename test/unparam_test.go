...
func IgnoreTestUnparam(t *testing.T) {
	t.Parallel()
	source := `package foo
...
var SliceElems = []func(FooType) []int{AsSliceElem} `
	expected := lint.Issues{
		{Position: token.Position{Filename: "test.go", Offset: 0, Line: 13, Column: 19}, Msg: `parameter b is unused`},
		{Position: token.Position{Filename: "test.go", Offset: 0, Line: 20, Column: 20}, Msg: `parameter f is unused`},
		{Position: token.Position{Filename: "test.go", Offset: 0, Line: 41, Column: 28}, Msg: `parameter a is unused`},
		{Position: token.Position{Filename: "test.go", Offset: 0, Line: 47, Column: 42}, Msg: `parameter f is unused`},
		{Position: token.Position{Filename: "test.go", Offset: 0, Line: 60, Column: 43}, Msg: `parameter f is unused`},
		{Position: token.Position{Filename: "test.go", Offset: 0, Line: 79, Column: 30}, Msg: `parameter s is unused`},
	}
